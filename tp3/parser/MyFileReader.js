...
class MyFileReader {
	...
	*/
	...
	loadRacetrack(rootElement) {
		...
		let racetrackElement = rootElement.getElementsByTagName("track");
		if (racetrackElement == null || racetrackElement.length != 1) {
			throw new Error("Track element is missing.");
		}
        ...
        // path
        let trackPoints = rootElement.getElementsByTagName("points");
        ...
        if (racetrackObj.points.length < 4) {
            throw new Error("The racetrack path should have at least 4 points");
        }

        // powerups
        let powerUpElements = rootElement.getElementsByTagName("powerups");
        ...
        //obstacles
        let obstacleElements = rootElement.getElementsByTagName("obstacles");
