...
class MyWindow {
    ...
    buildFrame() {
        ...
        const planeGeomtry = new THREE.PlaneGeometry(2.2, 1.3);
        ...
        const geometry1 = new THREE.BoxGeometry(1.5, 0.2, 0.05),
            geometry2 = new THREE.BoxGeometry(2, 0.2, 0.05);
